...
fun Activity.requestPermission() {
    if (ActivityCompat.shouldShowRequestPermissionRationale(
        ...
        showRationalDialog(this) //Dialog adicional por si quiere darle permisos a través de la app de settings
    }
}
...
fun Activity.isPermissionGranted(): Boolean {
    ...
    return if (isAndroidQOrLater.not()) { //Si no es mayor no hace falta pedir los permisos en tiempo de ejecución, se pueden pedir al principio
        true
    } else {
